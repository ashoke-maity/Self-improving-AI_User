...
function Sidebar() {
  ...
  return (
    <div className="bg-gray-900 border-r border-gray-800 h-screen w-64 flex flex-col justify-between p-4 flex-shrink-0">
      <div>
        ...
        <nav className="space-y-1">
          {menuItems.map((item, index) => (
            <div
              key={index}
              className="group flex items-center gap-3 px-3 py-3 text-sm font-medium text-gray-400 rounded-lg hover:bg-gray-800 hover:text-white transition-all duration-200 cursor-pointer"
            >
      ...
      <div className="pt-4 border-t border-gray-800">
        <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-800 transition-colors cursor-pointer">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-gray-700 to-gray-600 border border-gray-500 flex items-center justify-center text-sm font-bold text-white shadow-sm">
            JD
          </div>
